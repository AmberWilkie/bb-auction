...
https://c.pxhere.com/photos/b6/da/pencil_sharpener_pencil_pencil_tip_school_school_supplies-899557.jpg
https://c.pxhere.com/photos/0f/a9/yarn_ball_wool_string_blanket-6058.jpg
https://c.pxhere.com/photos/81/be/sport_shoe_running_shoe_shoe_blue_jeans_rubber_sole_black_run_jog-602034.jpg
https://c.pxhere.com/images/48/5a/cdfbe9bd1f158824fb715953ca04-1419113.jpg
]
...
(1..20).to_a.each do |num|
  ...
  5.times do
    Product.create(name: "#{product_adjectives.sample} #{product_nouns.sample}",
                   ...
                   offered: true,
                   description: Faker::Lorem.words(rand(20..500)))
  end
end
